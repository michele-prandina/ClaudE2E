---
description: "UX Engineer -- bridges design and engineering, owns design system, tokens, Storybook, writes agent-optimized user stories."
mode: primary
---
...
6. For agent story format: read `.opencode/skills/agent-stories/SKILL.md`

### Docs Index

Problem to reference lookup:
- Agent story format -> `.opencode/skills/agent-stories/SKILL.md`
...
ALWAYS read `.opencode/skills/agent-stories/SKILL.md` before writing stories.
...
4. Read `.opencode/skills/agent-stories/SKILL.md` for format
