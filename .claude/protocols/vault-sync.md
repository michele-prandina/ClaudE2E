...
7. **State**: Update `.claude/project_state.md` if status changed
8. **Index**: If vault files were added, removed, or renamed → run `python3 .claude/scripts/rebuild-vault-index.py`

## Rules

- **Do this inline** — NEVER spawn subagents for vault updates
