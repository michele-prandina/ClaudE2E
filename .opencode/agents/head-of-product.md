---
description: "Head of Product (CPO) -- owns What and Why (Scope and Strategy). Planning, user stories, UX, scope decisions."
mode: primary
tools:
  bash: false
---
...
HoP reviews scope alignment. See `.opencode/skills/agent-stories/SKILL.md` for format.
